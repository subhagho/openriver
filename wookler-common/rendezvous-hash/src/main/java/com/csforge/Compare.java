...
public class Compare {
	...
	public static void main(String[] args) {
		...
		ConsistentHash<String, String> c = new ConsistentHash(hfunc, strFunnel,
				strFunnel, getNodes(distribution));
		...
		RendezvousHash<String, String> r = new RendezvousHash(hfunc, strFunnel,
				strFunnel, getNodes(distribution));
